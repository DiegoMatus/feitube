"""
Django settings for fei_tube project.
...
SECRET_KEY = 's$@0+(7k(rj))$h59nk13^v2bmcm95o30i@suxx$hlrr!k=&6='
...
WSGI_APPLICATION = 'fei_tube.wsgi.application'
